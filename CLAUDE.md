...
**Status:** Iteration 1, Steps 0–4 done (64 tests). Step 5 (real Claude in `llm.py`) is next — it needs an API key and Willie's approval before the first live run. `PLAN.md` is the build spec. Work its steps in
