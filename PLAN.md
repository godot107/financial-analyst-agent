...
- ✅ **Per-run trace** (`fin_analyst/trace.py`) and a **hand-checked gold set** (`evals/gold.py`): 57 figure and ratio checks against four 10-Ks' text ($0), and 10 graded questions (first run 33/36, $0.52; causes fixed, not re-run).
